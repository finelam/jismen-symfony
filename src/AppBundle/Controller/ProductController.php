...
class ProductController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            $entity->upload();
            $entity->setPriceTtc($entity->getPriceHt()*$entity->getTva()->getRate()/100) ;
            $em = $this->getDoctrine()->getManager();
            $em->persist($entity);
            $em->flush();

            return $this->redirectToRoute('product_show', array('id' => $entity->getId()));
        }
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            $entity->setPriceTtc($entity->getPriceHt() + ($entity->getPriceHt()*$entity->getTva()->getRate()/100)) ;
            $entity->upload();
            $em->flush();
