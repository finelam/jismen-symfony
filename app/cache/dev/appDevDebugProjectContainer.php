...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/vip');
        ...
        $n->add($l, array(0 => 'IS_AUTHENTICATED'), NULL);
        $n->add($m, array(0 => 'ROLE_ADMIN'), NULL);

        $o = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $p = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '598290ac9ab77398f4fee6922fe23adbf425de06', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
